(defproject clj_chestnut "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "clj_chestnut.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main clj-chestnut.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "clj-chestnut.core/on-figwheel-reload"}

                :compiler {:main clj-chestnut.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clj_chestnut.js"
